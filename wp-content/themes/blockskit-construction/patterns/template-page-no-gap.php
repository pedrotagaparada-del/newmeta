 ...
 * Slug: blockskit-construction/template-page-no-gap
 * Categories: template
 * Inserter: false
 */
...
<!-- wp:cover {"url":"<?php echo esc_url($blockskit_construction_images[0]); ?>","id":79,"dimRatio":80,"overlayColor":"foreground","focalPoint":{"x":0.5,"y":0},"minHeight":480,"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|large"}}},"layout":{"type":"constrained"}} -->
